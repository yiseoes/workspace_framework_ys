...
public class MyBatisTestApp09 {
	...
	public static void main(String[] args) throws Exception{
		...
		SqlSessionFactoryBean.printList( sqlSession.selectList("UserMapper09.getUserList03",search) );
		...
		SqlSessionFactoryBean.printList( sqlSession.selectList("UserMapper09.getUserList04",search) );
