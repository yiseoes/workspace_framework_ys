...
<c:set var="purchase" value="${empty purchase ? purchaseVO : purchase}" />
...
<div class="panel">
  ...
  <form action="${pageContext.request.contextPath}/updatePurchase.do" method="post">
    ...
    <div class="actions">
      ...
      <a class="btn" href="${pageContext.request.contextPath}/getPurchase.do?tranNo=${purchase.tranNo}">취소</a>
    </div>
  </form>
</div>
</body>
