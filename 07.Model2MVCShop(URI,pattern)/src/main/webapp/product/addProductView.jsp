...
<form name="detailForm" action="${pageContext.request.contextPath}/product/listProduct" method="get">
...
<!-- 실제 상품 등록 폼 시작 -->
<form name="productForm" action="${pageContext.request.contextPath}/product/addProduct" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
  ...
  <tr>
    ...
    <td class="ct_write01">
      <input type="text" name="manufactureDay" readonly="readonly" class="ct_input_g"
...
<div style="text-align:right; margin-top:10px;">
  ...
  <button type="reset" onclick="location.href='${pageContext.request.contextPath}/product/listProduct?prodNo=${product.prodNo}'">취소</button>
</div>
