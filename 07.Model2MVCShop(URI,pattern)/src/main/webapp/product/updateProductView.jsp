...
<c:choose>
  ...
  <!-- 상품 수정 form -->
  <form name="productForm" action="${pageContext.request.contextPath}/product/updateProduct" method="post">
	...
	<div style="text-align:right; margin-top:10px;">
	  ...
	  <button type="button" onclick="location.href='${pageContext.request.contextPath}/product/getProduct?prodNo=${product.prodNo}'">취소</button>
	</div>
